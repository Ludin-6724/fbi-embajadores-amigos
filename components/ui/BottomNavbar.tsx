        ...
        {tabs.map((tab) => {
          ...
          if (tab.isCenter) {
            return (
              <button
                ...
                className="relative -top-3 flex flex-col items-center justify-center min-w-[50px]"
              >
                <div className="w-12 h-12 bg-gold rounded-full flex items-center justify-center shadow-lg transform active:scale-95 transition-all border-4 border-white">
                  <Icon size={24} className="text-white" />
                </div>
                <span className="text-[9px] font-bold text-gold mt-1">
                  {tab.label}
                </span>
              </button>
            );
          ...
          return (
            <button
              ...
              onClick={() => onTabChange(tab.id)}
              className={cn(
                "flex flex-col items-center justify-center flex-1 py-1 transition-all min-w-[45px]",
