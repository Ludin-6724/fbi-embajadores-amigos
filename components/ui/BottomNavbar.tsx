...
import { Home, Heart, PlusCircle, Flame, User, Zap } from "lucide-react";
...
export default function BottomNavbar({ activeTab, onTabChange }: BottomNavbarProps) {
  ...
  return (
    <>
      {/* ⚡ Floating Force-Update Lightning Button — always visible */}
      <button
        onClick={handleForceUpdate}
        className="fixed bottom-20 right-4 z-[200] w-11 h-11 bg-gold text-white rounded-full shadow-xl flex items-center justify-center active:scale-90 transition-all hover:bg-gold/90 border-2 border-white"
